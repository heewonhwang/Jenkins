...
<%
	...
	if(strPdfDataType.equals("0")){
		strRtDataPath 		= "C:/Users/hwanghw/eclipse-workspace/no_rt/WebContent/Sample/RP/REX_Sample.dat";   //data 파일경로
		strPdfFilePath 		= "C:/Users/hwanghw/eclipse-workspace/no_rt/WebContent/Sample/RP/REX_Sample.pdf";   //pdf 파일경로	
	}else{
