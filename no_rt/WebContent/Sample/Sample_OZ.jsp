...
<%
	...
	String	strPdfDataType = request.getParameter("strPdfDataType");		
	...
	if(strPdfDataType.equals("0")){//세로
		strRtDataPath 		= "C:/Users/hwanghw/eclipse-workspace/no_rt/WebContent/Sample/OZ/OZ_Sample.dat";   //data 파일경로
		strPdfFilePath 		= "C:/Users/hwanghw/eclipse-workspace/no_rt/WebContent/Sample/OZ/OZ_Sample.pdf";   //pdf 파일경로
		
	}else{//가로
		strRtDataPath 		= "C:/Users/hwanghw/eclipse-workspace/no_rt/WebContent/Sample/OZ_REX_garo_2page.dat";   //data 파일경로
		strPdfFilePath 		= "C:/Users/hwanghw/eclipse-workspace/no_rt/WebContent/Sample/OZ_REX_garo_2page.pdf";   //pdf 파일경로
	}
